...
private val AryaDarkScheme = darkColorScheme(
    ...
    secondary = AryaSilver,
    onSecondary = AryaSilverOn,
    secondaryContainer = AryaSilverContainerDark,
    onSecondaryContainer = AryaSilverContainer,
    tertiary = AryaEmber,
...
private val AryaLightScheme = lightColorScheme(
    ...
    secondary = AryaSilverOn,
    onSecondary = AryaPaper,
    secondaryContainer = AryaSilverContainer,
    onSecondaryContainer = AryaSilverOn,
    tertiary = AryaEmber,
